...
(function () {
  ...
  function injectCSS() {
    ...
    style.textContent = `
      ...
      .sidebar { position:fixed !important; left:0 !important; top:0 !important; bottom:0 !important; width:min(360px,88vw) !important; height:100dvh !important; max-height:none !important; padding:78px 0 28px !important; overflow-y:auto !important; transform:translate3d(-105%,0,0) !important; visibility:hidden !important; pointer-events:none !important; z-index:10950 !important; box-shadow:24px 0 70px rgba(0,0,0,.55) !important; transition:transform .28s ease,visibility 0s linear .28s !important; }
      ...
      @media(max-width:768px){
        ...
        .main{padding:16px 12px 40px !important}.tool-content{padding:18px 14px !important;width:100% !important;max-width:none !important}.row{flex-direction:column !important;align-items:stretch !important}.row>*{width:100% !important;max-width:100% !important}.tool-content input,.tool-content select,.tool-content textarea{font-size:16px !important}.tool-content .btn{width:100% !important}.sidebar{padding-top:72px !important}.sidebar ul{padding:3px 10px !important}.category-heading{padding:14px 16px 6px !important;font-size:.66rem !important}.sidebar ul li{min-height:44px !important;padding:10px 12px !important;font-size:.79rem !important}
      }
    `;
